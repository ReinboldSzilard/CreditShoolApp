...
public class MaterialsAndCreditsImpl implements iMaterials {
    ...
    public MaterialsAndCreditsImpl(String materialsName1, String materialsName2, String materialsName3,
                                   String materialsName4, String materialsName5, String materialsName6,
                                   String materialsName7, int credits1, int credits2, int credits3, int credits4,
    ...
    public void calculateNoteAndCredits() {
        ...
        System.out.println("CREDITE TOTALE" + " = " + resultMaterialsAndCredit +
                "\nMedia finala" + " = " + resultMaterialsAndCredit / creditGathering);
    }
}
